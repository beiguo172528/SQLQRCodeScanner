...
@interface SQLCustomButton ()

@property (nonatomic, strong) UIView *backgroudView;

@end

@implementation SQLCustomButton


- (id)initWithFrame:(CGRect)frame type:(SQLCustomButtonType)type imageSize:(CGSize)imageSize midmargin:(CGFloat)midmargin{
    if (self = [super initWithFrame:frame]) {
        ...
        if (type == SQLCustomButtonLeftImageType) {
        ...
        if (type == SQLCustomButtonTopImageType) {
        ...
        if (type == SQLCustomButtonRightImageType) {
...
- (void)touchAction:(void (^)(SQLCustomButton * _Nonnull))block{
